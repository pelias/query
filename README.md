...
**note:** The name of the field we used to store the `lat/lon` data is stored under the key `centroid:field` in our variable defaults and the elasticsearch field type must be set to 'geo_point'.
